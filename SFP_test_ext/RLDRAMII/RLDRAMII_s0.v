...
module RLDRAMII_s0 (
		...
		input  wire [143:0] phy_read_fifo_q,             //                 .phy_read_fifo_q
		...
		output wire [37:0]  afi_addr,                    //              afi.afi_addr
		output wire [5:0]   afi_ba,                      //                 .afi_ba
		output wire [1:0]   afi_cs_n,                    //                 .afi_cs_n
		output wire [1:0]   afi_ref_n,                   //                 .afi_ref_n
		output wire [1:0]   afi_we_n,                    //                 .afi_we_n
		output wire [143:0] afi_wdata,                   //                 .afi_wdata
		...
		input  wire [143:0] afi_rdata,                   //                 .afi_rdata
		...
		output wire [35:0]  scc_dq_ena,                  //                 .scc_dq_ena
	...
	rw_manager_rldram #(
		...
		.VIRTUAL_MEM_READ_DQS_WIDTH           (4),
		.MEM_READ_DQS_WIDTH                   (2),
		.VIRTUAL_MEM_WRITE_DQS_WIDTH          (4),
		.MEM_WRITE_DQS_WIDTH                  (2),
		.AFI_RATIO                            (2),
		.AC_BUS_WIDTH                         (29),
		.HCX_COMPAT_MODE                      (0),
		.DEVICE_FAMILY                        ("ARRIAV"),
		.AC_ROM_INIT_FILE_NAME                ("RLDRAMII_s0_AC_ROM.hex"),
		.INST_ROM_INIT_FILE_NAME              ("RLDRAMII_s0_inst_ROM.hex"),
	...
	altera_mem_if_sequencer_mem_no_ifdef_params #(
		...
		.AVL_SYMBOL_WIDTH (8),
		.MEM_SIZE         (22528),
		.INIT_FILE        ("RLDRAMII_s0_sequencer_mem.hex"),
		.RAM_BLOCK_TYPE   ("AUTO")
	) sequencer_mem (
	...
	RLDRAMII_s0_mm_interconnect_0 mm_interconnect_0 (
	...
	RLDRAMII_s0_irq_mapper irq_mapper (
		.clk        (avl_clk),                       //       clk.clk
